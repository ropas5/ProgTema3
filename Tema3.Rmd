...
download.file(url=URL,destfile= "df" )
...
paises<-df %>%
  filter(location ==c("United States","Italy","France","Germany","Canada","Japan","united Kingdom","Spain"))
         
ggplot(paises, aes(x=date,  y=new_deaths_per_million, fill=location,colour=location))+geom_line()+geom_point()+labs(title="Daily new confirmed COVID-19 deaths per million")
